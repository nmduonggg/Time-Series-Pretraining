...
class InputEmbedding(nn.Module):
    ...
    def __init__(self, in_dim, c_dim, seq_len, d_model, band_num, project_mode, learnable_mask):
        ...
        self.band_encoding = nn.Parameter(torch.randn(band_num, d_model).float(), requires_grad=True)  # learnable band encoding
    ...
    def forward(self, mask, data, power, need_mask, mask_by_ch, rand_mask, mask_len, use_power):
        ...
        power_emb = torch.einsum('hijk, kl->hijl', power.float(), self.band_encoding)
